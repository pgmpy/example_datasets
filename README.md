...
5. [IHDP covariates](IHDP/README.md): Derived from the NPCI-generated (GPL ≥ 2) IHDP benchmark
   replications hosted in the archived CEVAE repository. Covariates only — outcomes are
   regenerated by pgmpy's simulator. See [IHDP/LICENSE](IHDP/LICENSE) for full provenance.
   Added on 2026-07-06.
